# ⚡ Constitution THIRTY3

> *Ce document est la loi fondamentale de Michael en tant que THIRTY3.*
> *Il ne se modifie pas à la légère. Il se lit régulièrement.*
> *Il est la réponse à la question : "Qui es-tu vraiment ?"*

---

## I. Déclaration d'Identité
...
## III. Red Lines — Ce Qui Ne Se Négocie Pas

Ces lignes définissent les limites au-delà desquelles je ne suis plus THIRTY3.

### Red Lines Personnelles
1. **Aucun mensonge** — à moi-même ou aux autres, quelle que soit la raison
2. **Aucun acte contre mes valeurs** — même sous pression sociale ou émotionnelle
3. **Aucune procrastination sur les priorités P1** — ce qui compte en premier passe en premier
4. **Aucune consommation déviante** — contenu, comportements qui détournent mon énergie
5. **Aucun abandon face à la résistance** — la résistance signale l'importance

### Red Lines HexStrike (Non-Négociables Éthiques et Légaux)
1. **Aucun accès non autorisé** — jamais, sans exception, sans scope signé
2. **Aucune attaque sur des systèmes hors scope** — même si la vulnérabilité est évidente
3. **Aucune conservation de données personnelles** au-delà de la durée de l'engagement
4. **Aucune divulgation publique** sans passer par la divulgation responsable (90 jours minimum)
5. **Aucun travail pour des acteurs dont les intentions sont illégales ou non éthiques**

---

## IV. La Mission THIRTY3 + HexStrike

Ma mission n'est pas d'être parfait.
Ma mission est de construire, jour après jour, une vie qui prouve qui je suis.

HexStrike est l'expression de THIRTY3 dans le monde professionnel :
protéger ceux qui ne savent pas qu'ils sont vulnérables —
journalistes, enquêteurs, entreprises québécoises —
avec des outils open source, une méthodologie rigoureuse,
et une éthique absolue.

---

## V. Engagements Quotidiens

Je m'engage à :
- Compléter le Protocole Matin chaque matin, sans exception
- Compléter le Protocole Soir chaque soir, sans exception
- Être honnête dans mes scores — jamais de complaisance
- Documenter ma preuve du jour, aussi petite soit-elle
- Relire cette Constitution au moins une fois par semaine

---

## VI. Révision de la Constitution

Cette Constitution peut évoluer — mais uniquement après une réflexion profonde.
Toute modification doit être datée et motivée.
