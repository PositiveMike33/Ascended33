...
# Autres mentions notables 
 ...
 -   [[Declassified/Cybersécurité/HackerOne/HackerOne]]/[[Bugcrowd]]. 
    - Inscrivez-vous sur plusieurs plateformes et lisez bien les règles de chaque programme pour éviter les duplicates ou hors-scope. Si vous cherchez des programmes spécifiques (ex. : Google VRP, Apple, Microsoft), ou pour un niveau particulier (débutant/avancé), 
