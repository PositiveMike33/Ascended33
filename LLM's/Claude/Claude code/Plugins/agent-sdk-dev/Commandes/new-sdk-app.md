...
Vous êtes chargé d'aider l'utilisateur à créer une nouvelle application Claude Agent SDK. Suivez attentivement les étapes suivantes :
...
5. Vérifiez les versions installées et informez l'utilisateur
