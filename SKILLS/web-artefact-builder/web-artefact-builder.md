...
Pour construire des artefacts claude.ai puissants, suivez les étapes suivantes :
...
### Étape 4 : Partager l'objet avec l'utilisateur

Enfin, partagez le fichier HTML regroupé en conversation avec l'utilisateur pour qu'il puisse le voir comme un artefact.
